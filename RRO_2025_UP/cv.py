...
field_mat = [[70, 33, 10, 10, 10, 32, 70, 70], [63, 70, 33, 10, 10, 32, 70, 70], [63, 70, 11, 11, 70, 7041, 70, 70],
             [63, 70, 11, 11, 11, 10, 10, 11], [70, 70, 11, 11, 70, 70, 70, 70], [30, 70, 30, 30, 70, 70, 70, 7041],
             [11, 70, 33, 32, 70, 70, 70, 70], [1140, 70, 33, 10, 10, 70, 70, 7050], ]
...
def createMapMatrix(frame):
    ...
    for i in range(8):
        for j in range(8):
            ...
            xR, yR, wR, hR = searchForColor(ImageHSV, downRed, upRed)
            xG, yG, wG, hG = searchForColor(ImageHSV, downRed, upRed)
            xY, yY, wY, hY = searchForColor(ImageHSV, downRed, upRed)
            xO, yO, wO, hO = searchForColor(ImageHSV, downRed, upRed)
            xB, yB, wB, hB = searchForColor(ImageHSV, downRed, upRed)
            if wY * hY > 0:
                field_mat = 0
            elif wG * hG > 0:
                # зеленая труба
